...
func TestWindowsReleaseVersionAndCanceledDownload(t *testing.T) {
	...
	cancel()
	if _, err := officialWindowsDownload(ctx, "https://github.com/Shenrui-Ma/Laodi/releases/download/v0.0.0/SHA256SUMS-windows", 65536); !errors.Is(err, context.Canceled) {
